...
REF_FORWARD_DECL(IIRBase_TypeDefinition);
...
public:
  ...
  void set_base_type( IIR_TypeDefinitionRef );
  IIR_TypeDefinitionRef get_base_type();
  ...
  virtual void set_declaration( IIR_DeclarationRef );
  ...
  IIR_TypeDefinitionRef        get_subtype() { return IIR_TypeDefinitionRef(this); }
  IIR_ScalarTypeDefinitionRef  get_resolved_index_subtype();
  void                         set_index_subtype( IIR_ScalarTypeDefinitionRef );
  ...
  IIR_TypeDefinitionRef is_compatible( IIR_TypeDefinitionRef );
  IIR_TypeDefinitionRef check_special_compatible( IIR_TypeDefinitionRef );

  IIR_TypeDefinitionRef get_bottom_base_type();
...
private:
  IIR_TypeDefinitionRef   my_base_type;
  IIR_DeclarationRef      my_declaration;
