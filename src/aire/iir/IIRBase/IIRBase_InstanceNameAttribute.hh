#ifndef IIRBASE_INSTANCE_NAME_ATTRIBUTE_HH
#define IIRBASE_INSTANCE_NAME_ATTRIBUTE_HH
...
class IIRBase_InstanceNameAttribute : public virtual IIRBase_Attribute,
...
protected:
  ...
  virtual ~IIRBase_InstanceNameAttribute() = 0;
