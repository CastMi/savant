...
public:
  IIR_Kind get_kind() const override { return IIR_VARIABLE_INTERFACE_DECLARATION; }
  IIR_CharConstRef get_kind_text() const override { return IIR_CharConstRef("IIR_VariableInterfaceDeclaration"); }
