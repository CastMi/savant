#ifndef IIRBASE_QUIET_ATTRIBUTE_HH
#define IIRBASE_QUIET_ATTRIBUTE_HH
...
class IIRBase_QuietAttribute : public virtual IIRBase_Attribute, public virtual IIR_QuietAttribute{
...
protected:
  ...
  virtual ~IIRBase_QuietAttribute() = 0;
