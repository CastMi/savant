...
IIRRef
IIRBase_ArchitectureStatementList::successor(IIR_ArchitectureStatementRef node) {
  return IIR_List::successor(node);
}

void
IIRBase_ArchitectureStatementList::append_element(IIR_ArchitectureStatementRef to_append) {
  append( to_append );
}
