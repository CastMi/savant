...
IIRBase_MultiplicationOperator::IIRBase_MultiplicationOperator() {}
IIRBase_MultiplicationOperator::~IIRBase_MultiplicationOperator() {}

const string &
IIRBase_MultiplicationOperator::get_operator_string() const {
...
bool
IIRBase_MultiplicationOperator::is_associative(IIR_Kind oper_kind){
  switch(oper_kind) {                         
