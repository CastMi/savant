...
#ifndef IIRBASE_VALUE_ATTRIBUTE_HH
#define IIRBASE_VALUE_ATTRIBUTE_HH
...
class IIRBase_ValueAttribute : public virtual IIRBase_Attribute,
			       public virtual IIR_ValueAttribute{
public:

  IIR_Kind get_kind() const override {
    return IIR_VALUE_ATTRIBUTE;
  }
  IIR_CharConstRef get_kind_text() const override {
    return IIR_CharConstRef("IIR_ValueAttribute");
  }
...
protected:
  ...
  IIRBase_ValueAttribute();
  virtual ~IIRBase_ValueAttribute() = 0;
