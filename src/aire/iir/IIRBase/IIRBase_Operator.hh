#ifndef IIRBASE_OPERATOR_HH
#define IIRBASE_OPERATOR_HH
...
public:
  IIRBase_Operator(){} 
  virtual ~IIRBase_Operator() {};

  void publish_vhdl_operator( ostream &os );
...
typedef refcount<IIRBase_Operator> IIRBase_OperatorRef;
