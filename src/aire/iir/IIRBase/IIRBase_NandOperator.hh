...
public:
  ...
  IIR_Kind get_kind() const override { return IIR_NAND_OPERATOR; }
  IIR_CharConstRef get_kind_text() const override { return IIR_CharConstRef("IIR_NandOperator"); }
...
typedef refcount<IIRBase_NandOperator> IIRBase_NandOperatorRef;
