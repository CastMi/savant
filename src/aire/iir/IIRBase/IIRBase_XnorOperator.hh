...
#ifndef IIRBASE_XNOR_OPERATOR_HH
#define IIRBASE_XNOR_OPERATOR_HH
...
class IIRBase_XnorOperator : public virtual IIRBase_DyadicOperator,
...
protected:
  ...
  IIRBase_XnorOperator();
  virtual ~IIRBase_XnorOperator() = 0;
    
private:
};

typedef refcount<IIRBase_XnorOperator> IIRBase_XnorOperatorRef;
