#ifndef IIRSCRAM_CONCURRENT_PROCEDURE_CALL_STATEMENT_HH
#define IIRSCRAM_CONCURRENT_PROCEDURE_CALL_STATEMENT_HH
...
typedef refcount<IIRScram_ConcurrentProcedureCallStatement> IIRScram_ConcurrentProcedureCallStatementRef;
