#ifndef IIRSCRAM_PATH_NAME_ATTRIBUTE_HH
#define IIRSCRAM_PATH_NAME_ATTRIBUTE_HH
...
#include "IIRBase_PathNameAttribute.hh"
...
public:
  ...
  IIRScram_DeclarationRef _get_implicit_declaration( const string &, 
