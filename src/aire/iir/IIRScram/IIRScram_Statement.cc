...
IIRScram_Statement::_type_check_iteration_scheme( IIRScram_ConstantDeclaration *iteration_scheme ){
...
IIRScram_Label *
IIRScram_Statement::_lookup_label( IIR_Boolean complain_on_error ){
