#ifndef IIRSCRAM_SIMPLE_NAME_ATTRIBUTE_HH
#define IIRSCRAM_SIMPLE_NAME_ATTRIBUTE_HH
...
typedef refcount<IIRScram_SimpleNameAttribute> IIRScram_SimpleNameAttributeRef;
