#ifndef IIRSCRAM_LOW_ATTRIBUTE_HH
#define IIRSCRAM_LOW_ATTRIBUTE_HH
...
public:
  ...
  void _set_suffix( IIRScramRef new_suffix ){ IIRBase_LowAttribute::set_suffix( new_suffix ); }
...
typedef refcount<IIRScram_LowAttribute> IIRScram_LowAttributeRef;
