#ifndef IIRSCRAM_ATTRIBUTE_SPECIFICATION_LIST_HH
#define IIRSCRAM_ATTRIBUTE_SPECIFICATION_LIST_HH
...
typedef refcount<IIRScram_AttributeSpecificationList> IIRScram_AttributeSpecificationListRef;
