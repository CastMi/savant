#ifndef IIRSCRAM_RIGHT_ATTRIBUTE_HH
#define IIRSCRAM_RIGHT_ATTRIBUTE_HH
...
public:
  ...
  void _set_suffix( IIR_Statement *new_suffix ){ IIRBase_RightAttribute::set_suffix( new_suffix ); }
