...
class IIRScram_LengthAttribute : public virtual IIRScram_Attribute, public virtual IIRBase_LengthAttribute{
...
public:
  ...
  void _set_suffix( IIRScramRef new_suffix ){ IIRBase_LengthAttribute::set_suffix( new_suffix ); }
...
typedef refcount<IIRScram_LengthAttribute> IIRScram_LengthAttributeRef;
