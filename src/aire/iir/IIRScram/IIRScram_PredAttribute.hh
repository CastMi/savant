#ifndef IIRSCRAM_PRED_ATTRIBUTE_HH
#define IIRSCRAM_PRED_ATTRIBUTE_HH
...
class IIRScram_PredAttribute : public virtual IIRScram_Attribute, public virtual IIRBase_PredAttribute{
...
public:
  ...
  void _set_suffix( IIRScramRef new_suffix ){ IIRBase_PredAttribute::set_suffix( new_suffix ); }
...
typedef refcount<IIRScram_PredAttribute> IIRScram_PredAttributeRef;
