...
IIRScram_TypeDefinition::_determine_type_of_bound( IIRScram *left_or_right ){
   ...
   switch( left_or_right_types->size() ){
      ...
      default:{
                 if( left_or_right_types->find( dynamic_cast<IIRScram_IntegerSubtypeDefinition *>(package->get_savant_universal_integer()) ) != left_or_right_types->end() ){
                 ...
                 else if( left_or_right_types->find( dynamic_cast<IIRScram_FloatingSubtypeDefinition *>(package->get_savant_universal_real()) ) != left_or_right_types->end() ){
