#ifndef IIRSCRAM_LAST_ACTIVE_ATTRIBUTE_HH
#define IIRSCRAM_LAST_ACTIVE_ATTRIBUTE_HH
...
typedef refcount<IIRScram_LastActiveAttribute> IIRScram_LastActiveAttributeRef;
