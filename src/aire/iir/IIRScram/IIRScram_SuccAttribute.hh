#ifndef IIRSCRAM_SUCC_ATTRIBUTE_HH
#define IIRSCRAM_SUCC_ATTRIBUTE_HH
...
class IIRScram_SuccAttribute : public virtual IIRScram_Attribute, public virtual IIRBase_SuccAttribute{
...
public:
  ...
  void _set_suffix( IIRScramRef new_suffix ){ IIRBase_SuccAttribute::set_suffix( new_suffix ); }
...
typedef refcount<IIRScram_SuccAttribute> IIRScram_SuccAttributeRef;
