#ifndef IIRSCRAM_SELECTED_NAME_BY_ALL_HH
#define IIRSCRAM_SELECTED_NAME_BY_ALL_HH
...
typedef refcount<IIRScram_SelectedNameByAll> IIRScram_SelectedNameByAllRef;
