...
class IIRScram_RightOfAttribute : public virtual IIRScram_Attribute, public virtual IIRBase_RightOfAttribute{
...
public:
  ...
  void _set_suffix( IIRScramRef new_suffix ){ IIRBase_RightOfAttribute::set_suffix( new_suffix ); }
