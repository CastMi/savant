...
#ifndef IIR_SHARED_VARIABLE_DECLARATION_HH
#define IIR_SHARED_VARIABLE_DECLARATION_HH
...
class IIR_SharedVariableDeclaration : public virtual IIR_ObjectDeclaration{
public:
