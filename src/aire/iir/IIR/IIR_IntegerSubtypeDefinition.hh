...
class IIR_IntegerSubtypeDefinition : public virtual IIR_IntegerTypeDefinition{
...
typedef refcount<IIR_IntegerSubtypeDefinition> IIR_IntegerSubtypeDefinitionRef;
