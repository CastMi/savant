...
#ifndef IIR_SIGNAL_DECLARATION_HH
#define IIR_SIGNAL_DECLARATION_HH
...
class IIR_SignalDeclaration : public virtual IIR_ObjectDeclaration{
public:
...
typedef refcount<IIR_SignalDeclaration> IIR_SignalDeclarationRef;
