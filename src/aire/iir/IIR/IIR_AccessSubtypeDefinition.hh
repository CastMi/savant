#ifndef IIR_ACCESS_SUBTYPE_DEFINITION_HH
#define IIR_ACCESS_SUBTYPE_DEFINITION_HH
...
class IIR_AccessSubtypeDefinition : public virtual IIR_AccessTypeDefinition{
